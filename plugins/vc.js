...
handler.help = ['bass', 'blown', 'deep', 'earrape', 'fast', 'fat' , 'reverse', 'robot', 'slow', 'smooth', 'tupai'].map(v => v + ' [vn]')
handler.tags = ['audio']
handler.command = /^(bass|blown|deep|earrape|fast|reverse|robot|slow|smooth|tupai|squirrel|chipmunk)$/i
