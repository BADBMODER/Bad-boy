...
// THIS PLUGIN IS OWNED BY BADBMODER_BADBOY
...
// EXPORTING
        reply = await message.client.sendMessage(message.jid,' 𝚄𝙿𝙻𝙾𝙰𝙳𝙸𝙽𝙶 𝙼𝙴𝙳𝙸𝙰 🤗',MessageType.text);
        await message.client.sendMessage(message.jid, Buffer(respovideo.data), MessageType.video, {mimetype: Mimetype.mp4, caption: '◄━━⦁⦁ *𝙼𝙰𝙳𝙴 𝙱𝚈 ʙᴀᴅʙᴏʏ 𝚂𝙴𝚁* ⦁⦁━━►',})
